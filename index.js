const renderTasksProgressData = (tasks) => {
    // garantia de que tasks sempre seja array
    ...
    // evita mostrar "undefined/undefined concluídas"
...
const removeTask = (taskId) => {
    ...
    // evita erro ao remover <li> que não existe (manipulada por fora, por ex.)
    const list = document.getElementById("todo-list");
    const li = document.getElementById(taskId);
    if (list && li) list.removeChild(li);
}
